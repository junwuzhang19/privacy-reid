...
class BaseImageDataset(BaseDataset):
    ...
    def print_dataset_val_statistics(self, train, query, gallery, val_query, val_gallery):
        num_train_pids, num_train_imgs, num_train_cams = self.get_imagedata_info(train)
        num_query_pids, num_query_imgs, num_query_cams = self.get_imagedata_info(query)
        num_gallery_pids, num_gallery_imgs, num_gallery_cams = self.get_imagedata_info(gallery)
        num_val_query_pids, num_val_query_imgs, num_val_query_cams = self.get_imagedata_info(val_query)
        num_val_gallery_pids, num_val_gallery_imgs, num_val_gallery_cams = self.get_imagedata_info(val_gallery)
        ...
        print("  val_gallery  | {:5d} | {:8d} | {:9d}".format(num_val_gallery_pids, num_val_gallery_imgs, num_val_gallery_cams))
        print("  ----------------------------------------")
